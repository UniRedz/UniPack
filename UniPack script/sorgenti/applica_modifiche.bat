...
if not exist "mods\Clumps-forge-1.19.2-9.0.0+14.jar" (
    echo   ^> Clumps (XP orbs ottimizzati)...
    powershell -Command "Invoke-WebRequest -Uri 'https://cdn.modrinth.com/data/Wnxd13zP/versions/3GURrv52/Clumps-forge-1.19.2-9.0.0%%2B14.jar' -OutFile 'mods\Clumps-forge-1.19.2-9.0.0+14.jar'"
...
if not exist "mods\canary-mc1.19.2-0.3.3.jar" (
    echo   ^> Canary (ottimizzazione CPU)...
...
if not exist "mods\ImmediatelyFast-Forge-1.4.0+1.19.2.jar" (
    echo   ^> ImmediatelyFast (rendering entita)...
    powershell -Command "Invoke-WebRequest -Uri 'https://cdn.modrinth.com/data/5ZwdcRci/versions/OWO57F2j/ImmediatelyFast-Forge-1.4.0%%2B1.19.2.jar' -OutFile 'mods\ImmediatelyFast-Forge-1.4.0+1.19.2.jar'"
